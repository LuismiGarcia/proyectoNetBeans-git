...
class Jugada
{
    ...
    public function comparaJugada($clave){
        ...
        //quitamos colores duplicados para contar cuantos colores diferentes se han acertado
        $jugada = array_unique($this->jugada);
        foreach ($jugada as $color)
        if (in_array($color, $clave))//Se buscan los colores de la jugada en el array de la clave
